...
export const optimizedIndexingFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    // -----------------------------------------------------------------------
    // The TS chunker implementation was removed in favor of the chunker microservice.
    // We call the chunker service and adapt its response to the previous shape.
